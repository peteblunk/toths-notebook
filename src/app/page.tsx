...
export default function Home() {
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-900 text-cyan-400 font-display">
        ...
        <p className="mt-4 text-[10px] text-cyan-600/50 uppercase tracking-[0.3em]">
          <a href="https://ibislabs.cloud" target="_blank" rel="noopener noreferrer" className="hover:text-cyan-400/80 transition-colors font-headline">
  ...
  // Redirect in progress — show loading screen to avoid blank flash
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-900 text-cyan-400 font-display">
      <svg className="animate-spin h-10 w-10 text-cyan-400 mb-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
        <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
