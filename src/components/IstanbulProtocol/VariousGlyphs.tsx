  ...
  <g id="glyph-5-sled" stroke={ink} fill="none" strokeWidth="0.19" transform="translate(-0.65, 0)">
    <path id="sled-path" d="m 23.31,179.45 -0.01,-0.37 8.68,0.2 -0.36,-0.76 1.09,-0.03 -0.09,1.12 z" />
     ...
     <g id="non-hero-glyphs">
      {/* 1. the-captive */}
      <g id="the-captive">
        <path id="glyph-3-11" d="m 28.172613,210.65514 c -0.438486,-0.0731 -0.584647,1.68086 -0.986589,1.75394 -0.401944,0.0731 -1.030077,0.42897 -0.913509,0.89524 0.219241,0.87696 -0.913509,1.44334 -0.913509,1.44334" fill="none" stroke={ink} strokeWidth="0.258" strokeLinecap="round" strokeLinejoin="round" style={{ opacity: 0.78 }} />
        <path id="glyph-3-10" d="m 23.276205,214.89382 1.644317,0.84043 0.423538,-0.97367" fill="none" stroke={ink} strokeWidth="0.258" strokeLinecap="round" strokeLinejoin="round" style={{ opacity: 0.78 }} />
        ...
        <path id="glyph-3-7" d="m 22.969922,211.38012 c 0.155027,-1.36941 1.522226,-1.67145 2.351252,-1.44692 1.24022,0.33589 1.291895,1.4986 1.291895,1.4986" fill="none" stroke={ink} strokeWidth="0.258" strokeLinecap="round" strokeLinejoin="round" style={{ opacity: 0.78 }} />
        <path id="glyph-3-6" d="m 23.61587,212.3878 -0.103352,1.96368" fill="none" stroke={ink} strokeWidth="0.258" strokeLinecap="round" strokeLinejoin="round" style={{ opacity: 0.78 }} />
        <path id="glyph-3-5" d="m 31.936269,209.96342 v 2.09544" fill="none" stroke={ink} strokeWidth="0.242" strokeLinecap="round" strokeLinejoin="round" style={{ opacity: 0.78 }} />
        <path id="glyph-3-4" d="m 31.93627,212.77448 v 2.22896" fill="none" stroke={ink} strokeWidth="0.258" strokeLinecap="round" strokeLinejoin="round" style={{ opacity: 0.78 }} />
        <path id="glyph-3-3" d="m 31.93627,215.6479 v 1.99972" fill="none" stroke={ink} strokeWidth="0.244" strokeLinecap="round" strokeLinejoin="round" style={{ opacity: 0.78 }} />
        <path id="glyph-3-1" d="m 31.97281,218.40007 v 1.56113" fill="none" stroke={ink} strokeWidth="0.216" strokeLinecap="round" strokeLinejoin="round" style={{ opacity: 0.78 }} />
        <path id="glyph-3-2" d="m 26.592243,211.43163 -3.57182,-0.064" fill="none" stroke={ink} strokeWidth="0.258" strokeLinecap="round" strokeLinejoin="round" style={{ opacity: 0.78 }} />
      </g>
      ...
      <g id="glyph-2-oar">
        ...
        <path id="oar-3" d="m 24.210142,228.30397 -0.05168,6.04607 -0.852651,0.93017 h 1.4986 l -0.645949,-0.90433" fill="none" stroke={ink} strokeWidth="0.258" strokeLinecap="round" strokeLinejoin="round" style={{ opacity: 0.78 }} />
        <path id="oar-2" d="m 23.150787,233.9108 0.684705,0.58135" fill="none" stroke={ink} strokeWidth="0.258" strokeLinecap="round" strokeLinejoin="round" style={{ opacity: 0.78 }} />
        <path id="oar-1" d="m 25.11447,233.92372 -0.723462,0.6847" fill="none" stroke={ink} strokeWidth="0.258" strokeLinecap="round" strokeLinejoin="round" style={{ opacity: 0.78 }} />
      </g>
